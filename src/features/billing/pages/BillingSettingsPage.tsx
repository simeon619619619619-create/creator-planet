    ...
    return (
      <div className="text-center py-12">
        ...
        <button
          ...
          className="bg-[var(--fc-text,white)] text-[var(--fc-surface,black)] px-6 py-2 rounded-lg font-medium hover:bg-[var(--fc-button-hover,#E0E0E0)] transition-colors"
        >
        ...
        <div className="flex items-center gap-4 p-4 bg-[var(--fc-section,#0A0A0A)] rounded-lg mb-6">
          ...
          {currentTier !== 'scale' && (
            <button
              ...
              className="bg-[var(--fc-text,white)] text-[var(--fc-surface,black)] px-4 py-2 rounded-lg text-sm font-medium hover:bg-[var(--fc-button-hover,#E0E0E0)] transition-colors"
            >
            ...
            <div className="flex items-start gap-4">
              ...
              <div className="flex-1">
                ...
                <button
                  ...
                  disabled={isConnectLoading}
                  className="bg-[var(--fc-text,white)] text-[var(--fc-surface,black)] px-4 py-2 rounded-lg text-sm font-medium hover:bg-[var(--fc-button-hover,#E0E0E0)] transition-colors flex items-center gap-2 disabled:opacity-50"
                >
                  {isConnectLoading ? (
                    <>
            ...
            <div className="flex items-center gap-4 p-4 bg-[var(--fc-section,#0A0A0A)] rounded-lg">
              ...
              {connectStatus.status !== 'active' && (
                <button
                  onClick={handleSetupPayouts}
                  disabled={isConnectLoading}
                  className="bg-[var(--fc-text,white)] text-[var(--fc-surface,black)] px-4 py-2 rounded-lg text-sm font-medium hover:bg-[var(--fc-button-hover,#E0E0E0)] transition-colors disabled:opacity-50"
                >
