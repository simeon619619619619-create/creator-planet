...
export function TBICalculator({
  ...
  if (loading) {
    return (
      <div className={`bg-[var(--fc-section,#0A0A0A)] rounded-lg p-6 ${className}`}>
        <div className="flex items-center justify-center gap-2 text-[var(--fc-section-muted,#666666)]">
  ...
  if (schemes.length === 0) {
    return (
      <div className={`bg-[var(--fc-section,#0A0A0A)] rounded-lg p-4 ${className}`}>
  ...
  return (
    <div className={`space-y-3 ${className}`}>
      {/* Header */}
      <div className="flex items-center gap-2 text-[var(--fc-section-muted,#A0A0A0)]">
        <img
      ...
      <div className="bg-[#EAB308]/10 rounded-lg p-3 text-center">
        <span className="text-sm text-[var(--fc-section-muted,#A0A0A0)]">Обща сума: </span>
            ...
            <div
              ...
              className={`
                ...
                ${isSelected 
                  ...
                  : 'border-[var(--fc-section-border,#1F1F1F)] hover:border-orange-300 bg-[var(--fc-section,#0A0A0A)]'
                }
              `}
            >
              {/* Header row */}
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div className="text-left">
                    <div className="flex items-center gap-2">
                      ...
                      {scheme.name && (
                        <span className="px-2 py-0.5 bg-[var(--fc-section-hover,#1F1F1F)] text-[var(--fc-section-muted,#A0A0A0)] text-xs font-medium rounded-full">
                          {scheme.name}
                        </span>
                      )}
                    </div>
              ...
              {isExpanded && (
                <div className="px-3 pb-3 pt-0">
                  <div className="pl-8 space-y-2 text-sm">
                    {/* APR info */}
                    <div className="flex justify-between text-[var(--fc-section-muted,#A0A0A0)]">
                    ...
                    {/* Info note */}
                    <div className="flex items-start gap-1.5 text-xs text-[var(--fc-section-muted,#666666)] mt-2">
      ...
      {/* Disclaimer */}
      <p className="text-xs text-[var(--fc-section-muted,#666666)] text-center">
