              ...
              {hasActiveSubscription && (
                <div className="bg-[var(--fc-section-hover,#151515)] border border-[var(--fc-section-border,#1F1F1F)] rounded-lg p-4">
                  ...
                  <button
                    ...
                    className="flex items-center gap-2 bg-[var(--fc-text,white)] text-[var(--fc-surface,black)] px-4 py-2 rounded-lg text-sm font-medium hover:bg-[var(--fc-button-hover,#E0E0E0)] disabled:opacity-50"
                  >
                    {isOpeningPortal ? (
