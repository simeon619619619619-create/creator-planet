  ...
  if (applications.length === 0) {
    return (
      <div className="text-center py-12">
        ...
        <h3 className="text-lg font-medium text-gray-900 mb-1">{t('dwyPackages.myApplications.noApplicationsTitle')}</h3>
        <p className="text-gray-500">{t('dwyPackages.myApplications.noApplicationsDescription')}</p>
      </div>
    );
  }
