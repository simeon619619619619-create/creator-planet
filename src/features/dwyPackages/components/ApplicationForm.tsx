    ...
    <div className="fixed inset-0 bg-black/50 flex items-center justify-center p-4 z-50">
      <div className="bg-white rounded-2xl max-w-2xl w-full max-h-[90vh] overflow-y-auto">
        <div className="p-6 border-b border-gray-100">
          <h2 className="text-2xl font-bold text-gray-900">{t('dwyPackages.applicationForm.applyFor', { packageName: pkg.name })}</h2>
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-6">
          ...
          <div className="grid md:grid-cols-2 gap-4">
            <div>
              <label className="block text-sm font-medium text-gray-700 mb-1">
                {t('dwyPackages.applicationForm.businessNameLabel')} <span className="text-red-500">*</span>
              </label>
              <input
                type="text"
            ...
            <div>
              <label className="block text-sm font-medium text-gray-700 mb-1">
                {t('dwyPackages.applicationForm.businessTypeLabel')} <span className="text-red-500">*</span>
              </label>
              <select
          ...
          <div>
            <label className="block text-sm font-medium text-gray-700 mb-1">
              {t('dwyPackages.applicationForm.currentRevenueLabel')} <span className="text-red-500">*</span>
            </label>
            <select
          ...
          <div>
            <label className="block text-sm font-medium text-gray-700 mb-1">
              {t('dwyPackages.applicationForm.goalsLabel')} <span className="text-red-500">*</span>
            </label>
            <textarea
          ...
          <div>
            <label className="block text-sm font-medium text-gray-700 mb-1">
              {t('dwyPackages.applicationForm.timelineLabel')} <span className="text-red-500">*</span>
            </label>
            <select
