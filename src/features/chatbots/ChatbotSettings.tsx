      ...
      <div className="flex items-center justify-between p-4 border-b border-[var(--fc-section-border,#1F1F1F)]">
        ...
        {canAddMore && (
          <button
            ...
            className="flex items-center gap-1.5 px-3 py-1.5 bg-[var(--fc-text,white)] text-[var(--fc-surface,black)] text-sm font-medium rounded-lg hover:bg-[var(--fc-button-hover,#E0E0E0)] transition-colors"
          >
            <Plus size={16} />
      ...
      <div className="p-4">
        {chatbots.length === 0 ? (
          ...
          <div className="py-12 text-center">
            ...
            <button
              onClick={handleCreate}
              className="inline-flex items-center gap-1.5 px-4 py-2 bg-[var(--fc-text,white)] text-[var(--fc-surface,black)] text-sm font-medium rounded-lg hover:bg-[var(--fc-button-hover,#E0E0E0)] transition-colors"
            >
              <Plus size={16} />
