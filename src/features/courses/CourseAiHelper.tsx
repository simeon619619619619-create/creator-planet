    ...
    <>
      ...
      {!isOpen && (
        <button
          ...
          className="fixed bottom-6 right-6 z-50 bg-[var(--fc-text,white)] text-[var(--fc-surface,black)] p-4 rounded-full hover:bg-[var(--fc-button-hover,#E0E0E0)] transition-all hover:scale-110 flex items-center gap-2"
          ...
          <div className="p-4 bg-[var(--fc-section,#0A0A0A)] border-t border-[var(--fc-section-border,#1F1F1F)]">
            <div className="flex gap-2">
              ...
              <button
                ...
                className="bg-[var(--fc-text,white)] text-[var(--fc-surface,black)] p-2 rounded-lg hover:bg-[var(--fc-button-hover,#E0E0E0)] disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
