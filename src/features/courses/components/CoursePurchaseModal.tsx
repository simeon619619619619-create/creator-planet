    ...
    <form onSubmit={handleSubmit}>
      ...
      <div className="flex gap-3 mt-6">
        ...
        <button
          ...
          className="flex-1 bg-[var(--fc-text,white)] text-[var(--fc-surface,black)] px-4 py-3 rounded-xl font-medium hover:bg-[var(--fc-button-hover,#E0E0E0)] transition-colors disabled:opacity-50 flex items-center justify-center gap-2"
        >
          {isProcessing ? (
            <>
