            ...
            <div className="flex items-start gap-4">
              ...
              <div className="flex-1">
                ...
                <button
                  ...
                  className="mt-3 inline-flex items-center gap-2 bg-[var(--fc-text,white)] text-[var(--fc-surface,black)] px-4 py-2 rounded-lg text-sm font-medium hover:bg-[var(--fc-button-hover,#E0E0E0)] transition-colors disabled:opacity-50"
                >
                  {connectLoading ? (
                    <>
