        ...
        {showActions && (
          <div className="flex gap-2 mt-4">
            {teamMember.is_messageable && onSendMessage && (
              <button
                onClick={onSendMessage}
                className="flex-1 flex items-center justify-center gap-2 px-4 py-2.5 bg-[var(--fc-text,white)] text-[var(--fc-surface,black)] rounded-lg font-medium hover:bg-[var(--fc-button-hover,#E0E0E0)] transition-colors"
              >
                <MessageCircle size={18} />
              ...
              <button
                ...
                className={`flex items-center justify-center gap-2 px-4 py-2.5 rounded-lg font-medium transition-colors ${
                  teamMember.is_messageable && onSendMessage
                    ...
                    : 'flex-1 bg-[var(--fc-text,white)] text-[var(--fc-surface,black)] hover:bg-[var(--fc-button-hover,#E0E0E0)]'
                }`}
              >
                <User size={18} />
