                ...
                <div className="min-w-0">
                  <div className="flex items-center gap-2">
                    ...
                    {headerInfo.isOversightView && (
                      <span className="flex items-center gap-1 text-[10px] px-1.5 py-0.5 rounded-full font-semibold bg-slate-100 text-slate-600 shrink-0">
                        <Eye size={10} />
                  ...
                  {headerInfo.title && (
                    <p className="text-sm text-slate-500 truncate">{headerInfo.title}</p>
                  )}
                </div>
              </>
            )}
